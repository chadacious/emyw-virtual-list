...
Promise.all([
  runRollup({entry, output: 'emyw-virtual-list.es.js', format: 'es'}),
  runRollup({entry, output: 'emyw-virtual-list.cjs.js', format: 'cjs'}),
  runRollup({entry, output: 'emyw-virtual-list.js', format: 'umd'}),
  runRollup({entry, output: 'emyw-virtual-list.min.js', format: 'umd', minify: true}),
])
